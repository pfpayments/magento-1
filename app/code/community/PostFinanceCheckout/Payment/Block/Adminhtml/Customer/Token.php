 ...
 */
class PostFinanceCheckout_Payment_Block_Adminhtml_Customer_Token extends Mage_Adminhtml_Block_Widget_Grid implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        $collection = Mage::getModel('postfinancecheckout_payment/entity_tokenInfo')->getCollection()->addCustomerFilter(Mage::registry('current_customer')->getId());
    ...
    {
        return $this->getUrl(
            'adminhtml/postfinancecheckout_token/grid', array(
