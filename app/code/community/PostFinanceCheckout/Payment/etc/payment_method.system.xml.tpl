<config>
	<sections>
		<payment>
			<groups>
				<postfinancecheckout_payment_{id}>
					<label>PostFinance Checkout Payment - {name}</label>
					...
					<fields>
						...
						<title translate="label">
							...
							<frontend_model>postfinancecheckout_payment/adminhtml_system_config_form_field_label</frontend_model>
