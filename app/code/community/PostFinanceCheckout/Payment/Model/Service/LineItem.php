...
class PostFinanceCheckout_Payment_Model_Service_LineItem extends PostFinanceCheckout_Payment_Model_Service_Abstract
{
    ...
    public function collectInvoiceLineItems(Mage_Sales_Model_Order_Invoice $invoice, $amount)
    {
        ...
        Mage::dispatchEvent('postfinancecheckout_payment_convert_invoice_line_items',
            array(
                'result' => $result,
                'invoice' => $invoice
            ));
    ...
    public function collectLineItems($entity)
    {
        ...
        $result = new StdClass();
        $result->items = $lineItems;
        Mage::dispatchEvent('postfinancecheckout_payment_convert_line_items',
            array(
                'result' => $result,
                'entity' => $entity
            ));
        return $this->getLineItemHelper()->cleanupLineItems($result->items, $entity->getGrandTotal(),
            ...
            Mage::getStoreConfig('postfinancecheckout_payment/line_item/enforce_consistency', $entity->getStore()),
    ...
    protected function getProductLineItem($productItem, $currency)
    {
        ...
        Mage::dispatchEvent('postfinancecheckout_payment_convert_product_line_item',
            array(
                'result' => $result,
    ...
    protected function getShippingLineItem($entity)
    {
        ...
        if ($shippingInfo->getShippingAmount() > 0) {
            ...
            $result = new StdClass();
            $result->item = $lineItem;
            Mage::dispatchEvent('postfinancecheckout_payment_convert_shipping_line_item',
                array(
                    'result' => $result,
                    'entity' => $entity
                ));
